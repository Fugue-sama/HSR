            ...
            <div className="rl-img-desc-contain w-full md:w-[80%] h-fit relative flex justify-start gap-10">
                ...
                <div className="lc-desc p-1 w-fit">
                    ...
                    <div className="rl-set py-5 h-[6rem] relative text-[#cacaca] flex gap-5">
                            {relic.set_four ? (
                                <div className="relative h-full w-full flex gap-5">
                                   <img className="rl-suit h-full" src={getImage(set.Head)} alt="" />
                                   <img className="rl-suit h-full"  src={getImage(set.Hands)} alt="" />
                                   <img className="rl-suit h-full"  src={getImage(set.Body)} alt="" />
                                   <img className="rl-suit h-full" src={getImage(set.Feet)} alt="" />
                                </div>
                            ) : (
                                <div className="relative h-full w-full flex gap-5">
                                <img className="rl-suit h-full" src={getImage(set.PS)} alt="" />
                                <img className="rl-suit h-full" src={getImage(set.LR)} alt="" />
                             </div>
                            )}
                    </div>
                </div>
