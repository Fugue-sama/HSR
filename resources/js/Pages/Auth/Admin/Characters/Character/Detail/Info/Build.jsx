        ...
        return (
            <>
                <div className="trace-content relative w-full h-full flex justify-center items-center">
                    ...
                    <div className="absolute left-0 top-0 flex justify-center mb-4">
                        <div
                            className={`${
                    ...
                    <motion.div
                        ...
                        key={type}
                        ref={sliderRef}
                        className="slider w-full h-fit relative flex gap-10 justify-center px-12 mx-10 py-5 overflow-x-auto scroll-smooth"
                    >
                            {type === "relics" &&
